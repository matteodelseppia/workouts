...
**Why:** hit a 60kg dip 1RM on bars (Aug 9), well past this cycle's targets. Stepping off parallel bars — and off the Sept 1 comp — for ~2.5 months of low-rep ring dip work to give the elbows/shoulders a break before loading heavy again. Supersedes the original hypertrophy plan for this window; see the Aug 17 adjustments under Block 1.

**Goal:** maintain dip strength on rings with no bar work and no high-rep/failure sets on the push side. Low reps (3–5), moderate load, RIR 2–3 throughout — this is a deload for the joints, not a generic hypertrophy or strength block. Pull side switches over too, mirroring the Aug 17 session: Ring Weighted Pull Up, Advanced Tuck Front Lever Raise, and archer variations replace all bar pull-up/chin-up work.

**Targets for Nov 1 (set Aug 17):**
- Weighted Ring Dip 35kg x3 — tested Oct 27, confirmed Oct 31.
...
**Push-day bonus (from Aug 18):** Ring One Arm Push Up, 2 sets tacked on after tertiary on Tue and Thu — extra push volume that doesn't touch the secondary/tertiary pull balance.
...
- **Aug 18 (session 1):** first Block 2 session, Weighted Ring Dip top sets. Prescribed 4x3@20kg landed clean at RIR 2-3 as planned — no change to the top-set ramp. Two deliberate deviations, both kept going forward through the rest of the base phase (Aug 18 – Sept 24): (1) the backoff set moved from a near-top-load, low-rep dose (5 reps @ 15kg, i.e. ~top-5kg) to a genuinely lighter, higher-rep dose (10 reps @ ~top-7.5kg on Tue push-hard days, ~top-5kg on Thu push-technical days) — more total volume at a safer load, matching the "no grinding" joint-relief goal of this block; (2) Ring One Arm Push Up was added as a 4th, bonus exercise on both push days (6/side, 5/side after tertiary) — extra push volume on top of the existing pull-balanced secondary/tertiary, not a replacement for it. Every Tue/Thu file from Aug 20 through Sept 24 updated to match; Aug 18 itself is left as originally prescribed since it's already logged.
